    ...
    <div class="bonusList-wrapper">
            ...
            <div class="search-module">
                <div class="select-group">
                    <div class="switch-tab-box">
                        ...
                        <span class="switch-tab-item agreement-btn" :class="switchId === 1?'active':''" @click="switchTypeHandle(1)">分红契约</span>
                    </div>
        ...
        <div class="content" v-if="switchId === 1">
            ...
            <table class="order-table">
                ...
                <tbody>
                    <tr v-for="item in contractsList" v-if="contractsList.length">
                        <td>{{item.rebate}}%</td>
                        <td>{{item.valid_member}}</td>
                        <td>{{item.valid_money}}</td>
                        <td>{{item.cycle == 0? '每日':'每周'}}</td>
                        <td>{{item.profit}}</td>
                    ...
                    <tr v-if="!contractsList.length" class="no-data">
